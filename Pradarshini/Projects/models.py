...
class ProjectModel(models.Model):
    ...
    project_Year = models.IntegerField(choices=[(r,r) for r in range(2015, 2026)], default=2021)
    ...
    project_Domain = models.CharField(max_length=300,default="Big Data Analytics and Machine Learning")
